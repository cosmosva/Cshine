...
ALIYUN_OSS_DOMAIN=https://${OSS_BUCKET}.${OSS_ENDPOINT}

# 阿里云通义听悟配置
ALIYUN_TINGWU_APP_KEY=${TINGWU_APP_KEY}
ALIYUN_TINGWU_ACCESS_KEY_ID=${TINGWU_ACCESS_KEY_ID}
ALIYUN_TINGWU_ACCESS_KEY_SECRET=${TINGWU_ACCESS_KEY_SECRET}
